...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AppBibliaNVI.Configurar, AppBibliaNVI", Configurar.class, __md_methods);
	}
	...
	public Configurar ()
	{
		...
		if (getClass () == Configurar.class)
			mono.android.TypeManager.Activate ("AppBibliaNVI.Configurar, AppBibliaNVI", "", this, new java.lang.Object[] {  });
	}
